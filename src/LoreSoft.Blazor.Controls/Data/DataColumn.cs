...
/// <remarks>
/// Inherits the shared property metadata, formatting, sorting, filtering, search and export
/// configuration from <see cref="DataField{TItem}"/>.
/// </remarks>
[CascadingTypeParameter(nameof(TItem))]
public class DataColumn<TItem> : DataField<TItem>
{
    /// <summary>
    ...
    /// <inheritdoc />
    protected override void RegisterParent()
    {
        if (Grid == null)
    ...
    /// <inheritdoc />
    protected override void UnregisterParent()
    {
